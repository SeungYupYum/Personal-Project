import hashlib  # used for generating a hash of the URL.
import os
from urllib.parse import urlparse  # Used for parsing URLs.

from cbor import cbor  # used for loading CBOR-encoded files
